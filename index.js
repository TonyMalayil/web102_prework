...
const unfundedStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${numOfUnfundedGames} ${numOfUnfundedGames === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
...
const [firstGame, secondGame] = [...GAMES_JSON].sort( (item1, item2) => {
    return item2.pledged - item1.pledged;
});
